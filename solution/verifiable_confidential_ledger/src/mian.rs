...
fn flow_cn() {
    ...
    println!(
        "c1：{}",
        wedpr_crypto::utils::point_to_string(&c1_credit.get_point())
    );
    println!(
        "c2：{}",
        wedpr_crypto::utils::point_to_string(&c2_credit.get_point())
    );
    println!(
        "c3：{}",
        wedpr_crypto::utils::point_to_string(&c3_credit.get_point())
    );
    pause_cn();
